...
curl -s https://deloitte--aurora.sandbox.my.salesforce.com/services/data/v58.0/wave/dashboards \
...
curl -s https://deloitte--aurora.sandbox.my.salesforce.com/services/data/v58.0/wave/datasets \
    -H "Accept: application/json" \
    -H "Authorization: Bearer $token" \
    -o datasets.json \
...
curl -s https://deloitte--aurora.sandbox.my.salesforce.com/services/data/v58.0/wave/lenses \
    -H "Accept: application/json" \
    -H "Authorization: Bearer $token" \
    -o lenses.json \
